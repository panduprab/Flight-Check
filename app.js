...
function openEdit(id){
  ...
  document.getElementById('f-copilotName').value=log.copilotName||'';
...
function resetForm(){
  ['f-date','f-ama','f-estate','f-flightId','f-missionName','f-pilotName','f-copilotName','f-wingtraUnit',
...
function autofillFromMission(value) {
  ...
  fill('f-copilotName', match.copilotName);
...
function saveLog(){
  ...
  const entry={
    ...
    copilotName:document.getElementById('f-copilotName').value.trim(),
...
function doExport(){
  ...
  const cols=['date','ama','estate','flightId','missionName','pilotName','copilotName','wingtraUnit','batteryId','batteryIdB','batteryColor','startPct','endPct','usedPct','startVolt','endVolt','startTime','endTime','duration','notes'];
  const hdrs=['Date','AMA','Estate','Flight ID','Mission Name','Pilot Name','Copilot Name','Wingtra Unit','Battery ID 1','Battery ID 2','Battery Color','Start %','End %','Used %','Start Volt','End Volt','Start Time','End Time','Duration (min)','Notes'];
