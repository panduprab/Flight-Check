...
function doExport(){
  ...
  const cols=['date','ama','missionName','estate','flightId','pilotName','wingtraUnit','batteryId','batteryIdB','batteryColor','startPct','endPct','startVolt','endVolt','startTime','endTime','duration','notes'];
  const hdrs=['flight_date','ama','mission_name','estate','flight_id','pilot','uav_unit','battery_id','battery_id_2','battery_color','start_percent','end_percent','start_volt','end_volt','start_time','end_time','duration_min','notes'];
